 ...
 * ══════════════════════════════════════════════════════════════
 * Variables d'environnement attendues (fichier .env ou config hébergeur) :
...
// silence (ce qui couperait le pont Telegram ET toutes les sessions actives).
...
// connecter ton propre numéro via Telegram au moins une fois.
